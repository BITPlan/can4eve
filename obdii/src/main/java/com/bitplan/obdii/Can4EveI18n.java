...
public class Can4EveI18n {
  ...
  public static final String HISTORY_GROUP="historyGroup"; //history
  public static final String MAIN_GROUP="mainGroup"; //Info # com.bitplan.gui.Group info/INFO
  ...
  public static final String SETTINGS_FORM="settingsForm"; //OBDII
  public static final String OWNER_FORM="ownerForm"; //owner
  public static final String VEHICLE_FORM="vehicleForm"; //vehicle
