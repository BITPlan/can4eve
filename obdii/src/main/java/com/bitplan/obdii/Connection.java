...
/**
 * generic connection - could be implemented with sockets
 * @author wf
 *
 */
public interface Connection extends ResponseHandler {
  /**
   * get the InputStream 
  ...
  /**
   * get a response line - or possibly null if there was a timeout
   */
